        ...
        >
            ...
            >
                ...
                <Text style={{ fontSize: 16, fontWeight: 600 }}>
                    {`Chào mừng ${userDetail?.first_name} ${userDetail?.last_name}!`}
                </Text>
            ...
            >
                ...
                >
                    <FormControl>
                        <FormControl.Label>Họ tên đệm</FormControl.Label>
                        {isEditting ? (
                            <Input
                                value={firstName}
                    ...
                    <FormControl>
                        ...
                        {isEditting ? (
                            ...
                            <Text>{userDetail?.bank_name}</Text>
                        )}
                    </FormControl>
                    ...
                    <FormControl>
                        ...
                        {isEditting ? (
                            <Input
                                value={bankNum}
                                onChangeText={(text) => setBankNum(text)}
                            />
                        ) : (
                            <Text>{userDetail?.bank_num}</Text>
                        )}
                    </FormControl>
